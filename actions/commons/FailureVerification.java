...
public class FailureVerification extends HashMap<ITestResult, List<Throwable>> {
	private FailureVerification() {
		super();
	}

	public static FailureVerification getFailures() {
		if (failures == null) {
			failures = new FailureVerification();
		}
		return failures;
	}
	...
	private static FailureVerification failures;
}
